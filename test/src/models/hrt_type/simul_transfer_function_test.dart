...
void main() async {
  ...
  double input = 1.0;
  List<double> numerator = [1.0]; // Exemplo: Numerador de um sistema de primeira ordem
  List<double> denominator = [1.0, 1.0]; // Exemplo: Denominador

  // Criar uma instância da classe TransferFunction
  Duration samplingTime = Duration(milliseconds: 100); // Tempo de amostragem de 100 ms
